...
<header id="header">
    <div class="title-bar">
        <div class="title-bar-left">
            ...
            <a href="${path1 }/"><img alt="logo" src="${path1 }/resources/img/rlogo.png"></a>
        ...
        <%-- <div class="login-center">
            <c:if test="${empty sid }">
            <form class="login" action="${path1 }/member/signin.do" method="post">
            	<input type="text" class="clear" name="id" id="id" style="background-clolr:#A6B8C4">
            	<input type="password" class="clear" name="pw" id="pw">
            	<button type="submit" class="clear button success" id="acolor">Login</button>
            </form>
            </c:if>
        </div> --%>
